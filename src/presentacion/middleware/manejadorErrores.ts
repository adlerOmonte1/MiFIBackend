...
const CODIGO_A_STATUS: Record<string, number> = {
  ...
  NO_AUTENTICADO: 401,
  TRANSACCION_NO_ENCONTRADA: 404, // RF-50, D-05
  CATEGORIA_NO_ENCONTRADA: 404, // RF-36, RF-50
  META_AHORRO_NO_ENCONTRADA: 404, // RF-50, D-05
  META_AHORRO_INACTIVA: 409, // RF-32/AHO-01
};
